...
var GA = {
    ...
    MNLink: function () {
        ...
        var noResults = document.getElementById('searchResultText')
        if (noResults) {
            noResults.innerHTML = '<div class="mnLink" >Not found here?<br><a href="https://mnlink.on.worldcat.org/search?queryString=' + mySearch + '"  target="_blank" >Search MNLINK</a></div>';
        }
